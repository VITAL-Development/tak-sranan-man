...
| 2 | `unit-02-srn-sounds` | Klanken & spelling | A1 | alphabet, spelling, stress | new |
...
#### 2. `unit-02-srn-sounds` — Klanken & spelling (A1)
...
| `unit-02-srn-sounds` | Beginner | **Well-sourced** | Alphabet/spelling fixed by `language-settings.json`; no diacritics to dispute. |
